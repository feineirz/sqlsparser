export class SqlsParser {
    static aliases = {
        ...
        userrole: " user_role VARCHAR(64) NOT NULL DEFAULT 'User'",
        userlevel: ' user_level TINYINT UNSIGNED DEFAULT 0 ',
        username: ' username VARCHAR(64) NOT NULL UNIQUE ',
        name: ' name VARCHAR(100) NOT NULL UNIQUE ',
        displayname: " display_name VARCHAR(100) DEFAULT 'User' ",
        password: ' password VARCHAR(64) NOT NULL ',
